...
class MyDatabase:
    ...
    def createTables(self):
        try:
            ...
            self.cur.execute('''CREATE TABLE wins ( 
                                    ...
                                    country_code VARCHAR(5),
                                    discipline_code VARCHAR(40),
                                    event VARCHAR(100),
                                    primary key(athlete_name, medal_code, event),
    ...
    def readInData(self):
        try:
            ...
            insertLine5 = "insert into coach  (name, gender, birth_date, country_code, discipline, function, event) values (?, ?, ?, ?, ?, ?, ?);"
            ...
            insertLine9 = "insert into wins  (medal_code, athlete_name, country_code, discipline_code, event) values (?, ?, ?, ?, ?);"
            ...
            for line in coach[1:]:
                clean = line.strip().split(",")               
                self.execute(insertLine5, clean[0], clean[1],clean[2], clean[3], clean[4], clean[5], clean[6])
